...
## Project Structure
    ...
    ├── testapiautosetting_124241  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124241`
...
2. Clone this repo and `cd testapiautosetting_124241`
